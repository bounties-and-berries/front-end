...
import { useFonts as usePlayfair, PlayfairDisplay_900Black } from '@expo-google-fonts/playfair-display';
 ...
 <Text
  style={[
    styles.title,
    {
      ...
      fontFamily: 'Poppins-Bold', // Use a nice font
      letterSpacing: 0.5,
    },
  ]}
  numberOfLines={1}
...
>
  Bounties & Berries
            ...
            <Text style={[styles.subtitle, { color: theme.colors.card ,top:'13px'}]}>
          ...
          >
            ...
            <TouchableOpacity
              style={[styles.publicButton, { borderColor: theme.colors.border }]}
              onPress={handlePublicView}
            >
              <Text style={[styles.publicButtonText, { color: theme.colors.primary }]}>
