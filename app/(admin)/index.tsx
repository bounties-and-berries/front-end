...
import { Users, TrendingUp, Award, Calendar, ChartBar as BarChart3, Shield, Activity } from 'lucide-react-native';
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <View>
            ...
            <Text style={[styles.collegeName, { color: theme.colors.textSecondary }]}>
              {admin?.collegeName}
            </Text>
          </View>
          <Image
          ...
          <View style={styles.overviewCard}>
            <View style={styles.overviewHeader}>
              <View>
                ...
                <Text style={styles.overviewSubtitle}>System-wide statistics</Text>
              </View>
