...
import { Plus, CreditCard as Edit, Trash2, Shield, Award, Calendar, Users, BookOpen } from 'lucide-react-native';
...
export default function AdminRules() {
  ...
  const handleAddRule = () => {
    Alert.alert('Add Rule', 'Rule creation form will be available soon.');
  };
            ...
            {categoryStats.map((stat) => (
              <AnimatedCard key={stat.category} style={styles.categoryCard}>
                <View style={styles.categoryContent}>
                  ...
                  <Text style={[styles.categoryPoints, { color: theme.colors.primary }]}>
                    {stat.totalPoints} max points
                  </Text>
                </View>
              </AnimatedCard>
            ))}
              ...
              <AnimatedCard style={styles.emptyCard}>
                <View style={styles.emptyContent}>
                  ...
                  <Text style={[styles.emptySubtitle, { color: theme.colors.textSecondary }]}>
                    Create your first point rule to get started.
                  </Text>
                </View>
              </AnimatedCard>
            ) : (
