...
import { achievementAPI, eventAPI } from '@/services/api';
...
export default function FacultyHome() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setError(null);
      try {
        const achievements = await achievementAPI.getPendingAchievements();
        setPendingAchievements(achievements);
        const today = new Date().toDateString();
        setApprovedToday(
          achievements.filter(a => a.status === 'approved' && new Date(a.date).toDateString() === today).length
        );
                ...
                <View style={styles.overviewCard}>
                  ...
                  <View style={styles.overviewStats}>
                    <View style={styles.overviewStat}>
                      <Text style={styles.overviewStatValue}>{pendingAchievements.length}</Text>
