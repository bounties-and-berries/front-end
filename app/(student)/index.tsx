...
import { Trophy, Star, TrendingUp, Calendar, Gift, User } from 'lucide-react-native';
          ...
          <View style={styles.pointsCard}>
            ...
            <View style={styles.pointsFooter}>
              ...
              <Text style={styles.progressText}>
                {3000 - (student?.totalPoints || 0)} points to next level
              </Text>
            </View>
          </View>
        </GradientCard>
        ...
        <View style={styles.actionsGrid}>
          ...
          >
            ...
            >
              ...
              <Text style={styles.actionButtonText}>Join Events</Text>
            </LinearGradient>
          </TouchableOpacity>
          
          <TouchableOpacity 
            style={styles.actionButton}
            onPress={() => router.push('/(student)/rewards')}
          >
            <LinearGradient
